...
* **A Tecnologia:** A API foi feita usando Node.js com o microframework Express.
* **O Banco de Dados:** Como a atividade não exigia um banco de dados real (como MySQL ou MongoDB), Minha API usa uma estrutura de dados "em memória". Ou seja, os livros ficam salvos em um Array (let books = []) enquanto o servidor estiver ligado.
